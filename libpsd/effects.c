...
extern psd_status psd_get_layer_drop_shadow(psd_context * context, psd_layer_record * layer, psd_layer_effects_drop_shadow * drop_shadow);
extern psd_status psd_get_layer_drop_shadow2(psd_context * context, psd_layer_record * layer, psd_layer_effects_drop_shadow * drop_shadow);
extern psd_status psd_get_layer_inner_shadow(psd_context * context, psd_layer_record * layer, psd_layer_effects_inner_shadow * inner_shadow);
extern psd_status psd_get_layer_inner_shadow2(psd_context * context, psd_layer_record * layer, psd_layer_effects_inner_shadow * inner_shadow);
extern psd_status psd_get_layer_outer_glow(psd_context * context, psd_layer_record * layer, psd_layer_effects_outer_glow * outer_glow);
extern psd_status psd_get_layer_outer_glow2(psd_context * context, psd_layer_record * layer, psd_layer_effects_outer_glow * outer_glow);
extern psd_status psd_get_layer_inner_glow(psd_context * context, psd_layer_record * layer, psd_layer_effects_inner_glow * inner_glow);
extern psd_status psd_get_layer_inner_glow2(psd_context * context, psd_layer_record * layer, psd_layer_effects_inner_glow * inner_glow);
extern psd_status psd_get_layer_bevel_emboss(psd_context * context, psd_layer_record * layer, psd_layer_effects_bevel_emboss * bevel_emboss);
extern psd_status psd_get_layer_bevel_emboss2(psd_context * context, psd_layer_record * layer, psd_layer_effects_bevel_emboss * bevel_emboss);
extern psd_status psd_get_layer_color_overlay(psd_context * context, psd_layer_record * layer, psd_layer_effects_color_overlay * color_overlay);
extern psd_status psd_get_layer_color_overlay2(psd_context * context, psd_layer_record * layer, psd_layer_effects_color_overlay * color_overlay);
extern psd_status psd_get_layer_gradient_overlay2(psd_context * context, psd_layer_record * layer, psd_layer_effects_gradient_overlay * gradient_overlay);
extern psd_status psd_get_layer_pattern_overlay2(psd_context * context, psd_layer_record * layer, psd_layer_effects_pattern_overlay * pattern_overlay);
extern psd_status psd_get_layer_stroke2(psd_context * context, psd_layer_record * layer, psd_layer_effects_stroke * stroke);
extern psd_status psd_get_layer_satin2(psd_context * context, psd_layer_record * layer, psd_layer_effects_satin * satin);
	...
	for(i = 0; i < data->effects_count; i ++)
	{
		...
		switch(tag)
		{
			...
			case 'dsdw':	// drop shadow
				psd_get_layer_drop_shadow(context, layer, &data->drop_shadow);
			...
			case 'isdw':	// inner shadow
				psd_get_layer_inner_shadow(context, layer, &data->inner_shadow);
			...
			case 'oglw':	// outer glow
				psd_get_layer_outer_glow(context, layer, &data->outer_glow);
			...
			case 'iglw':	// inner glow
				psd_get_layer_inner_glow(context, layer, &data->inner_glow);
				data->fill[psd_layer_effects_type_inner_glow] = psd_true;
				data->valid[psd_layer_effects_type_inner_glow] = psd_true;
				break;
			case 'bevl':	// bevel
				psd_get_layer_bevel_emboss(context, layer, &data->bevel_emboss);
			...
			case 'sofi':	// solid fill (Photoshop 7.0)
				psd_get_layer_color_overlay(context, layer, &data->color_overlay);
		...
		switch(rootkey)
		{
			case 0:
				...
				if(strcmp(keychar, "patternFill") == 0)
				{
					...
					psd_get_layer_pattern_overlay2(context, layer, &data->pattern_overlay);
				...
				{
					psd_assert(0);
					psd_stream_get_object_null(type, context, layer);
				}
				break;
			...
			case 'DrSh':
				// Descriptor
				psd_assert(type == 'Objc');
				psd_get_layer_drop_shadow2(context, layer, &data->drop_shadow);
				data->fill[psd_layer_effects_type_drop_shadow] = psd_true;
				data->valid[psd_layer_effects_type_drop_shadow] = psd_true;
				data->effects_count ++;
				break;
			...
			case 'IrSh':
				// Descriptor
				psd_assert(type == 'Objc');
				psd_get_layer_inner_shadow2(context, layer, &data->inner_shadow);
				data->fill[psd_layer_effects_type_inner_shadow] = psd_true;
				data->valid[psd_layer_effects_type_inner_shadow] = psd_true;
				data->effects_count ++;
				break;
			...
			case 'OrGl':
				// Descriptor
				psd_assert(type == 'Objc');
				psd_get_layer_outer_glow2(context, layer, &data->outer_glow);
				data->fill[psd_layer_effects_type_outer_glow] = psd_true;
				data->valid[psd_layer_effects_type_outer_glow] = psd_true;
				data->effects_count ++;
				break;
			...
			case 'IrGl':
				// Descriptor
				psd_assert(type == 'Objc');
				psd_get_layer_inner_glow2(context, layer, &data->inner_glow);
				data->fill[psd_layer_effects_type_inner_glow] = psd_true;
				data->valid[psd_layer_effects_type_inner_glow] = psd_true;
				data->effects_count ++;
				break;
			...
			case 'ebbl':
				// Descriptor
				psd_assert(type == 'Objc');
				psd_get_layer_bevel_emboss2(context, layer, &data->bevel_emboss);
				data->fill[psd_layer_effects_type_bevel_emboss] = psd_true;
				data->valid[psd_layer_effects_type_bevel_emboss] = psd_true;
				data->effects_count ++;
				break;
			...
			case 'ChFX':
				// Descriptor
				psd_assert(type == 'Objc');
				psd_get_layer_satin2(context, layer, &data->satin);
			...
			case 'SoFi':
				// Descriptor
				psd_assert(type == 'Objc');
				psd_get_layer_color_overlay2(context, layer, &data->color_overlay);
				data->fill[psd_layer_effects_type_color_overlay] = psd_true;
				data->valid[psd_layer_effects_type_color_overlay] = psd_true;
				data->effects_count ++;
				break;
			...
			case 'GrFl':
				// Descriptor
				psd_assert(type == 'Objc');
				psd_get_layer_gradient_overlay2(context, layer, &data->gradient_overlay);
			...
			case 'FrFX':
				// Descriptor
				psd_assert(type == 'Objc');
				psd_get_layer_stroke2(context, layer, &data->stroke);
