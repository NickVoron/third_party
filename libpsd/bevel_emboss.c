...
psd_status psd_get_layer_bevel_emboss(psd_context * context, psd_layer_record * layer, psd_layer_effects_bevel_emboss * bevel_emboss)
{
...
psd_status psd_get_layer_bevel_emboss2(psd_context * context, psd_layer_record * layer, psd_layer_effects_bevel_emboss * bevel_emboss)
{
		...
		switch(rootkey)
		{
			case 0:
				...
				else if(strcmp(keychar, "phase") == 0)
				{
					...
					psd_stream_get_object_point(&bevel_emboss->texture_horz_phase, &bevel_emboss->texture_vert_phase, context);
				}
				else
				{
					psd_assert(0);
